...
//Avoid Mutations and Side Effects Using Functional Programming
{
  ...
  function incrementer() {
    // Only change code below this line
    let incrementedValue = fixedValue + 1;
...
//Pass Arguments to Avoid External Dependence in a Function
{
  ...
  // Only change code below this line
  function incrementer(currentValue) {
...
//Use the filter Method to Extract Data from an Array
{
  ...
  const watchListTrimmed = watchList.map((movie) => ({
    title: movie.Title,
    rating: movie.imdbRating,
  }));
  const filteredList = watchListTrimmed.filter((movie) => movie.rating >= 8.0);
...
//Use the reduce Method to Analyze Data
{
  ...
  function getRating(watchList) {
    ...
    const filteredList = watchList
      ...
      .map((rating) => parseFloat(rating.imdbRating));

    let averageRating =
      filteredList.reduce((sum, value) => sum + value) / filteredList.length;
    // Only change code above this line
